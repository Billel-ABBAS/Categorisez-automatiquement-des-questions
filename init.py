...
############################################ Partie teste supervisé dans le notebook #############################
...
# # Définition de la fonction de prédiction
# def predict_keywords_api(new_text, lda_model, nmf_model, vectorizer, train_topics_lda, train_topics_nmf, tags_train, vectorizer_tags):
