...
train_df = pd.read_csv('../Data/stack_overflow_data_cleaned.csv')
...
model_list = [
    ...
    ("Random Forest", OneVsRestClassifier(RandomForestClassifier(n_estimators=20), n_jobs=-1)),
    ...
    ("ElasticNet", OneVsRestClassifier(ElasticNet(max_iter=1000))),
    ("AdaBoost", OneVsRestClassifier(AdaBoostClassifier(n_estimators=20))),
]
